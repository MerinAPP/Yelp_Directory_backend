...
import { UpdateCategorySchema, updateSubCategoryInput, updateSubType } from "../../utils/validation/category.validation";


//@desc update category
//@method PATCH  /category/:category_id
//@access private
export const updateCategory = asyncHandler(async (req: IUserMessage<z.TypeOf<typeof UpdateCategorySchema>["params"], {}, updateSubType>, res: Response) => {
