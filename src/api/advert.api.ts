...
router.post("/", AuthJWT, isSuperOrSystemAdmin, upload.array('coverImage', 1), validateSchema(createAdvertSchema), createAdvert)
...
router.patch("/:advert_id", AuthJWT, isSuperOrSystemAdmin, upload.array('coverImage', 1), validateSchema(updateAdvertSchema), updateAdvert)
