import { object, string, TypeOf, date, array, number } from "zod";
export const registerUserSchema = object({
    body: object({
        ...
        registrationToken: string({ required_error: "Should have registration token" }).optional()
...
export const updateCustomerProfileSchema = object({
    body: object({
        ...
        interest: array(string()).optional(),
...
export type googleLoginUserInput = TypeOf<typeof googleLoginUserSchema>["body"];
